            ...
            <div class="card-body">
              ...
              <form class="row g-3" action ="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  ...
                  <input type="text" id="tags" value="{{ $tags }}" class="form-control" name="tags" data-role="tagsinput">
                </div>
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" name="meta_description"> {{ $getRecord->title }} </textarea>
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" value="{{ $getRecord->meta_keyword }}" name="meta_keyword">
