      ...
      <div class="row">
        ...
        @include('layouts.message')
          <div class="card">
            ...
            <div class="card-body">
            <h5 class="card-title">
            Blogs List (Total : {{ $getRecord->total() }})
                <a href="{{ url('panel/reviews/add') }}" class="btn btn-primary" style="float: right;margin-top -12px;"> Add New </a>
            </h5>
            ...
            <form class="row" accept="get">
              ...
              <label class="form-label" style="display: block;">&nbsp;</label>
                ...
                <a href="{{ url('panel/reviews/list') }}" class="btn btn-primary">Reset</a>
              </div>
            </form>
            ...
            <hr />
              ...
              <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('panel/reviews/edit/'.$value->id) }}" class="btn btn-primary btn-sm">Edit</a>
                        <a onclick="return confirm('Are you sure you want to delete this review?');" href="{{ url('panel/reviews/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                  </tr>
                    @empty
                    <tr>
